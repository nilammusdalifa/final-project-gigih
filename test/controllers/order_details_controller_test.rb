...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference("OrderDetail.count") do
      post order_details_url, params: { order_detail: { item_price: @order_detail.item_price, quantity: @order_detail.quantity } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { item_price: @order_detail.item_price, quantity: @order_detail.quantity } }
